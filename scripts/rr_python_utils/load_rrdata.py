...
if (sys.version_info.major == 2):
    ...
    if (sys.version_info.minor == 7):
        ...
        import libpyRR311_datafiles as rrData
        loaded_rrData= True
    elif (sys.version_info.minor == 12):
        import libpyRR312_datafiles as rrData
        loaded_rrData= True
    elif (sys.version_info.minor == 13):
        import libpyRR313_datafiles as rrData
        loaded_rrData= True
    elif (sys.version_info.minor == 14):
        import libpyRR314_datafiles as rrData
        loaded_rrData= True
if (not loaded_rrData):
    raise RR_GenericError("\n    Unable to load RR module for python version {}.{}.\n".format(sys.version_info.major,sys.version_info.minor))
else:
    rrLogger.info("libpyRR_datafiles v{} loaded ({})".format(rrData.getRRModuleVersion(), rrData.__file__))
    pass
