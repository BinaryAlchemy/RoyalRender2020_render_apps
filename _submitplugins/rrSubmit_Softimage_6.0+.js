...
function RRViewControl_Execute(  )
{
    ...
    if ((Application.Platform == "Win32" ) || (Application.Platform == "Win64" )) { 
        XSIUtils.LaunchProcess(getRR_root()+"\\bin\\win64\\rrControl.exe");
    } else {
...
{
    Application.LogMessage("rrSubmit %rrVersion%.");
    if (getRR_root()=="") return false;
    ...
    if ((Application.Platform == "Win32" ) || (Application.Platform == "Win64" )) { 
        XSIUtils.LaunchProcess("\""+getRR_root()+"\\bin\\win64\\rrSubmitter.exe\" \""+XMLFileName+"\"",false,getRR_root())
    } else {
...
function RRSubmitLocal_Execute(  )
{
    ...
    if ((Application.Platform == "Win32" ) || (Application.Platform == "Win64" )) { 
        XSIUtils.LaunchProcess("\""+getRR_root()+"\\bin\\win64\\rrSubmitterconsole.exe\" \""+LocalTexfilename+"\"",false,getRR_root())
    } else {
