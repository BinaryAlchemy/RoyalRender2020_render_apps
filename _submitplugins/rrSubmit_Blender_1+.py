...
class OBJECT_OT_SubmitScene(bpy.types.Operator):
    ...
    def get_ocio_config_file():
        ...
        default_cfg_file = os.path.join("<rrBaseAppPath><IsMac /Resources>", "<rrExeVersionFull>", "datafiles", "colormanagement", "config.ocio") #<IsMac must not be a seperate flag on its own (otherwise double // on windows)
