...
set "RR_REDSHIFT_BASE=c:\ProgramData\Redshift"
set "RR_REDSHIFT_BASE_LOCAL=%RR_REDSHIFT_BASE%"
@echo * RedShift source path is set to %RR_REDSHIFT_BASE%
set "REDSHIFT_COREDATAPATH=%RR_REDSHIFT_BASE_LOCAL%"
set "PATH=%RR_REDSHIFT_BASE_LOCAL%\bin;%PATH%"
set "REDSHIFT_LICENSEPATH=%RR_REDSHIFT_BASE_LOCAL%"
